...
console.log("A ", basic_Arr); // A  [ 0, 1, 2, 3, 4, 5 ]
...
const myn1 = basic_Arr.slice(1, 3); // exclude last range
console.log(myn1); // [ 1, 2 ]

console.log("B ", basic_Arr); // B  [ 0, 1, 2, 3, 4, 5 ]
...
console.log("C ", basic_Arr); // C  [ 0, 4, 5 ]
